        ...
        <section className="nosotros-section">
            ...
            <div className="mision-vision-container">
                <div className="mv-card">
                    <h3>Mision</h3>
                    <p>Ofrecer zapatillas urbanas de calidad combinando moda, comodidad y tecnologia para todos nuestros clientes.</p>
                </div>
                <div className="mv-card">
                    <h3>Vision</h3>
                    <p>Convertirnos en una de las tiendas urbanas mas reconocidas en Colombia por nuestra innovación y experiencia digital.</p>
                </div>
            </div>
        </section>
    )
